...
For step-by-step instructions on adding new labels to the translation table, see [FIXING-RAILTYPE-COMPATIBILITY.md](FIXING-RAILTYPE-COMPATIBILITY.md).

## See Also

- [VARACTION2-CALLBACKS.md](VARACTION2-CALLBACKS.md) - How the indexes are used
- [STANDARDIZED-RAILTYPE-SCHEME.md](STANDARDIZED-RAILTYPE-SCHEME.md) - Label naming convention
